...
import nodejs from "../exImgs/nodejs.png";
import shopify from "../exImgs/shopify.png";
import bootstrap from "../exImgs/bootstrap.png";
import mongodb from "../exImgs/mongodb.png";
import linux from "../exImgs/linux.png";
...
const Skills = () => {
  const portfolios = [
    ...
    { id: 10, src: shopify, title: "Shopify", style: "shadow-gray-300" },
    { id: 11, src: bootstrap, title: "Bootstrap", style: "shadow-gray-300" },
    { id: 12, src: mongodb, title: "MongoDB", style: "shadow-gray-300" },
    { id: 13, src: linux, title: "Linux", style: "shadow-gray-300" },
    { id: 14, src: nodejs, title: "nodejs", style: "shadow-gray-300" },
  ];

  return (
    <div
      name="skills"
      className="bg-gradient-to-b from-gray-800  to-black w-full pt-52"
    >
